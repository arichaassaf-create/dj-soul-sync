...
export default function About() {
  return (
    <Layout>
      <SEO
        title="אודות אסף אריכא | DJ לחתונות ומסיבות במרכז - מודיעין, רחובות, נס ציונה"
        description="אסף אריכא - תקליטן מקצועי לחתונות ומסיבות באזור המרכז: מודיעין, מזכרת בתיה, רחובות, נס ציונה וכרמי יוסף. ניסיון של שנים והתאמה אישית לכל אירוע."
        canonicalUrl="https://dj-assaf-aricha.co.il/about"
        keywords="DJ אסף אריכא, תקליטן מודיעין, דיג'יי רחובות, DJ נס ציונה, תקליטן מזכרת בתיה, דיג'יי כרמי יוסף, תקליטן לחתונות מרכז"
      />
