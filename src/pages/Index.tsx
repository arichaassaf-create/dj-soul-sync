...
const services = [
  ...
  },
  {
    ...
    title: "מסיבות פרטיות",
    description: "יום הולדת, בר/בת מצווה או כל חגיגה פרטית",
...
const testimonials = [
  {
    name: "רוני ודני כהן",
    event: "חתונה",
    text: "אסף הפך את החתונה שלנו לחוויה בלתי נשכחת! הרחבה לא הפסיקה לרקוד ברגע.",
    rating: 5,
  },
  {
    name: "מיכל לוי",
    event: "בת מצווה",
    text: "תקליטן מקצועי ברמה הגבוהה ביותר. ידע לקרוא את הקהל בצורה מושלמת.",
    rating: 5,
  },
  {
    name: "חברת הייטק XYZ",
    event: "אירוע חברה",
    text: "האירוע השנתי שלנו היה הכי מוצלח בזכות אסף. מומלץ בחום!",
    rating: 5,
  },
];
