...
const services = [
  ...
  },
  {
    ...
    icon: PartyPopper,
    title: "מסיבות פרטיות",
    subtitle: "יום הולדת, בר/בת מצווה או כל חגיגה משפחתית",
    image: privatePartyImage,
    description: "בין אם זה יום הולדת עגול, בר או בת מצווה, או סתם מסיבה משפחתית - אני יוצר את האווירה המושלמת שתגרום לכל האורחים לקפוץ מהכיסאות.",
    features: [
      "התאמת מוזיקה לגיל המשתתפים",
      "משחקים ופעילויות (בר/בת מצווה)",
...
export default function Services() {
  return (
    <Layout>
      <SEO
        title="שירותים | די ג'יי לחתונה ואירועים - אסף אריכא"
        description="שירותי DJ מקצועיים לחתונות, מסיבות פרטיות, אירועי חברה וייעוץ מוזיקלי. התאמה אישית לכל אירוע."
