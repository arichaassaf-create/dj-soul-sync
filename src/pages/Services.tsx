...
export default function Services() {
  return (
    <Layout>
      <SEO
        title="שירותי DJ לחתונות ומסיבות באזור המרכז | מודיעין, רחובות, נס ציונה"
        description="שירותי DJ מקצועיים לחתונות ומסיבות באזור המרכז - מודיעין, מזכרת בתיה, רחובות, נס ציונה וכרמי יוסף. תקליטן מנוסה עם התאמה אישית לכל אירוע."
        canonicalUrl="https://dj-assaf-aricha.co.il/services"
        keywords="שירותי DJ מרכז, תקליטן לחתונות מודיעין, DJ מסיבות רחובות, דיג'יי נס ציונה, תקליטן מזכרת בתיה, DJ כרמי יוסף, שירותי דיג'יי אזור המרכז"
      />
